...
Construct complex objects step by step while keeping construction readable.
...
HTTP request, user profile, immutable config.

## Interview Explanation

"The Builder pattern is useful when construct complex objects step by step while keeping construction readable. It improves maintainability by reducing direct dependency on changing implementation details."
