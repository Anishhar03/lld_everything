...
Add operations to object structures without changing element classes.

## Why This Pattern Exists

You need many operations across a stable object hierarchy.

In small programs you may not need Visitor. In LLD interviews, the pattern becomes useful when requirements start changing and direct code would become brittle.

## Real-World Analogy

Tax calculation across cart items, AST compiler passes.
...
`src/main/java/com/anish/lld/patterns/behavioral/VisitorDemo.java`
...
In the demo implementation, `TaxVisitor` is the center of the pattern.

Design pressure:

Tax operation varies across stable item hierarchy.
...
Add DiscountVisitor without changing item classes.
