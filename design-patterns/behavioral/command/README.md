...
Undo/redo, job queues, button actions.

## Interview Explanation

"The Command pattern is useful when encapsulate a request as an object. It improves maintainability by reducing direct dependency on changing implementation details."
