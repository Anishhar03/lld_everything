...
Event systems, stock price alerts, pub-sub.

## Interview Explanation

"The Observer pattern is useful when notify subscribers when state changes. It improves maintainability by reducing direct dependency on changing implementation details."
