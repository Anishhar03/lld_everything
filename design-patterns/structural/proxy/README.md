...
Caching proxy, security proxy, lazy loading proxy.

## Interview Explanation

"The Proxy pattern is useful when control access to another object. It improves maintainability by reducing direct dependency on changing implementation details."
