...
Two dimensions vary, and inheritance creates class explosion.

In small programs you may not need Bridge. In LLD interviews, the pattern becomes useful when requirements start changing and direct code would become brittle.

## Real-World Analogy

Remote types and device types vary independently.
...
`src/main/java/com/anish/lld/patterns/structural/BridgeDemo.java`
...
In the demo implementation, `Remote + Device` is the center of the pattern.

Design pressure:

Remote type and device type vary independently, avoiding many subclasses.
...
Add AdvancedRemote without changing TV or Radio classes.
