...
Share common immutable state to reduce memory usage.
...
Text editor characters, map markers, game particles.

## Interview Explanation

"The Flyweight pattern is useful when share common immutable state to reduce memory usage. It improves maintainability by reducing direct dependency on changing implementation details."
