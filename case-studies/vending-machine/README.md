...
Design a vending machine with inventory, item selection, coin/card payment, dispense, refund, and out-of-stock handling.
...
Inventory slot update and payment confirmation must be consistent. If dispense fails after payment, refund flow must be triggered.
