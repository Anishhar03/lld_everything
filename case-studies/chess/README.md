...
Design chess with board, pieces, legal moves, turns, check, checkmate, castling, promotion, and game result.
...
- Strategy for piece movement
- State for game status
- Factory for piece creation
...
If online, two players may send moves concurrently. Use game-level locking and validate turn order atomically.
