...
Design snake and ladder with board, dice, players, snakes, ladders, turns, and win condition.
...
- Strategy for dice rolling
- State for game lifecycle
...
For multiplayer online mode, turn updates must be atomic so two moves cannot happen for the same turn.
